...
What the skill carries from the worked reference page and the owner's requirements:
...
The skill follows the layout and the writing rules settled earlier in the marathon: a "Use when" description, the standard sections, references with contents lists, and prose that passes the humanizer.
