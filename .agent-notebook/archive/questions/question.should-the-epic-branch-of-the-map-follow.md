...
Dropped 2026-09-02: One scope rule for every surface: ready --for, list --for and graph --for agree on what an epic contains, and the wide picture is truthful, since the v1 hub waits on nearly everything. The narrow picture already exists as graph --focus <hub> --depth 1.
