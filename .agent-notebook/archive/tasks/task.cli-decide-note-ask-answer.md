...
Owner's call 2026-08-29: retire lands here — the CLI surface for the standalone, no-successor retirement of a Decision or Note (active -> retired). Core::retire already enforces the transition and idempotent replay; retirement with a successor stays decide/note --supersedes. The command vocabulary in the concept spec is amended accordingly.

Progress 2026-08-29: work done, Opus 5 review done, findings fixed, gate green. AWAITING OWNER REVIEW — 9 files uncommitted/unstaged.
