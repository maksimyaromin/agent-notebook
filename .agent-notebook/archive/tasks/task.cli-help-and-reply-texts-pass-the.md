...
type: task
state: closed
title: CLI help and reply texts read as plain prose, so the commands reference reads well
by: Maksim Yaromin
from: task.skills
tags: cli
...
- 2026-09-05 Maksim Yaromin: Review found eight more Core refusal messages with the prose dash and the 0–4 range; all rewritten, gate green.
