...
- 2026-08-30 Maksim Yaromin: Shipped in 80eec09: request.rs, reply.rs and a crate-private resolve.rs carry the vocabulary below the Notebook, notebook.rs became a directory module with write/query/check/error beside it, and the Core module graph is a DAG — encode, debt and status no longer import from notebook. Verified byte-identical against a HEAD build over nine notebooks at the time.
